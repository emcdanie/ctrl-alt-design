...
Requirements are the brief (Cowork, 2026-09-19) as locked in `design.md`. Gate: audit:layout,
...
- [x] T5 Hero: Term, lead, stats, certificate badges, Next up.
- [x] T6 Library: search, Type/Topic chips with counts, count, Clear filters, URL state.
- [x] T7 Timeline and Table views.
- [x] T8 Map view and its below-700px list.
- [x] T9 Skills view: MatrixView + Learned from column + key.
