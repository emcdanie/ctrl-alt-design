...
const caseStudies: CaseStudy[] = [
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    overview: {
      ...
      body: "Many digital products start with good intentions: a few components, a shared style guide, a design file that everyone agrees to follow. But as a product grows, something subtle begins to happen. This was the situation at ***REMOVED*** — a complex B2B SaaS platform with multiple booking flows and internal tooling evolving in parallel. I was the sole designer responsible for this work from beginning to end: conducting the audit, defining the architecture, authoring governance documentation, and working directly with engineering to ensure design decisions translated into reusable implementation.",
    },
    images: [
    ...
    clientLogo: "/images/logos/***REMOVED***.png",
    clientName: "***REMOVED***",
    description:
    ...
    narrative: [
      ...
      },
      {
        ...
        paragraphs: [
          "Alongside the internal audit, I spent time researching how mature design systems handle similar challenges at scale. I looked closely at Atlassian's Design System, Adobe Spectrum and ***REMOVED***, and several enterprise SaaS products operating in complex, data-dense contexts.",
