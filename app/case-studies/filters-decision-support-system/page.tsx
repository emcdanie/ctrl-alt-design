    ...
    <CaseStudyLayout>
      ...
      <div style={{ maxWidth: "760px", margin: "0 auto", padding: "64px 24px 80px" }}>
        ...
        <Section eyebrow="CONTEXT" heading="A Platform That Outgrew Its Patterns">
          <Body>
            ***REMOVED*** is a B2B travel management platform used by companies across Europe to book and
        ...
        <div style={{ marginTop: "40px", marginBottom: "32px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "12px" }}>
            <a
              href="/demos/***REMOVED***-search.html"
              target="_blank"
              rel="noopener noreferrer"
              className="demo-link"
            >
              <span aria-hidden>↗</span> ***REMOVED*** search prototype
            </a>
            <a
              href="/demos/***REMOVED***-filter-demo.html"
              target="_blank"
              rel="noopener noreferrer"
              className="demo-link"
            >
              <span aria-hidden>↗</span> ***REMOVED*** filter demo
            </a>
          </div>
        </div>
