    ...
    <CaseStudyLayout>
      ...
      >
        ...
        <Section eyebrow="PROTOTYPE" heading="Hackathon Prototype: Guardian Audit Tool">
          ...
          <div style={{ position: "relative", width: "100%", overflow: "hidden", borderRadius: "var(--radius-2xl)", marginTop: "var(--spacing-6)", marginBottom: "var(--spacing-6)", background: "var(--color-brand-ink)", border: "1px solid var(--color-alpha-parchment-6)" }}>
            <div style={{ position: "relative", aspectRatio: "16/10", width: "100%", minHeight: "480px" }}>
              <iframe
                ...
                style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", border: "none", borderRadius: "var(--radius-2xl)" }}
              />
            </div>
          </div>
        </Section>
        ...
        <Section eyebrow="EVOLUTION" heading="What Came After: Pattern Mentor">
          ...
          <div style={{ position: "relative", width: "100%", overflow: "hidden", borderRadius: "var(--radius-2xl)", marginTop: "var(--spacing-6)", marginBottom: "var(--spacing-6)", background: "var(--color-semantic-surface)", border: "1px solid rgba(0,0,0,0.06)" }}>
            <div style={{ position: "relative", aspectRatio: "16/10", width: "100%", minHeight: "480px" }}>
              <iframe
