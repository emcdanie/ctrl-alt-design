    ...
    <CaseStudyLayout>
      ...
      >
        ...
        <Section eyebrow="PROTOTYPE" heading="Hackathon Prototype: Guardian Audit Tool">
          ...
          <div style={{ position: "relative", width: "100%", overflow: "hidden", borderRadius: "var(--radius-xl)", marginTop: "var(--spacing-6)", marginBottom: "var(--spacing-6)", background: "#0F1117", border: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <Section eyebrow="EVOLUTION" heading="What Came After: Pattern Mentor">
          ...
          <div style={{ position: "relative", width: "100%", overflow: "hidden", borderRadius: "var(--radius-xl)", marginTop: "var(--spacing-6)", marginBottom: "var(--spacing-6)", background: "var(--color-semantic-surface)", border: "1px solid rgba(0,0,0,0.06)" }}>
            <div style={{ position: "relative", aspectRatio: "16/10", width: "100%", minHeight: "480px" }}>
              <iframe
