...
### PROMPT I — TravelPlatformDemo (***REMOVED***)

```
Create a self-contained interactive demo component at components/demos/TravelPlatformDemo.tsx.

This represents the ***REMOVED*** corporate travel platform — the product I redesigned in my case study.
...
### PROMPT J — UNDashboardDemo (***REMOVED*** Operational Command)

```
Create a self-contained interactive demo at components/demos/UNDashboardDemo.tsx.

This represents the ***REMOVED*** operational coordination dashboard I prototyped in my case study.
...
app/demos/layout.tsx
  ...
  - "← Back to case study" link (top-left, absolutely positioned, z-50)
    - Uses searchParams to get returnTo=?returnTo=/case-studies/***REMOVED***
...
app/demos/travel/page.tsx
  ...
  - Metadata: title "***REMOVED*** Travel Platform — Demo"
...
Props:
  ...
  demoLabel: string   // e.g. "Explore the ***REMOVED*** prototype"
...
Add to: app/case-studies/***REMOVED***/page.tsx and app/case-studies/un-operational-dashboard/page.tsx
```
