...
const study: CaseStudy = {
  ...
  heroImage: "",
  heroMedia: { type: "video", src: "/videos/hackathon-showreel.mp4" },
  metrics: {
  ...
  overview: {
    ...
    body: "Guardian is an AI-assisted concept that detects drift, surfaces contextual guidance, and helps teams make confident system decisions without leaving their workflow.",
  },
  images: [],
  problem: {
