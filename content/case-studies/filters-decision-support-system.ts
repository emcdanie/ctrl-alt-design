...
const study: CaseStudy = {
  ...
  blocks: [
    ...
    /* TODO(elleta): decision blocks. This case has none yet; the DST
       template renders decisions when they exist. Candidates from the
       existing prose: one-flow narrowing, policy as a visible
       dimension, reversible exploration. Her words, her pass. */
    {
      kind: "section",
