  ...
  blocks: [
    ...
    },
    {
      ...
      children: [
        ...
        { kind: "paragraph", text: "**Structured comparison.** The compare function generates an AI-assisted side-by-side analysis with pros, cons, and a recommendation. This supports the final stage of the decision: not just finding options, but choosing between them with confidence." },
