...
const GATE = [
  ...
  { name: "audit:sharp", line: "No picture is shown wider than half its pixels, on any route or inside any demo, at 1440 and 390, so nothing goes soft on a retina screen." },
